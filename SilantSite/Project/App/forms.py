...
class MaintenanceForm(forms.ModelForm):
    class Meta:
        model = Maintenance
        fields = ['maintenanceType', 'maintenanceDate','operatingTime', 'workOrderNumber', 'workOrderDate', 'maintenanceCompany', 'vehicle', 'serviceCompany', ]

class ClaimsForm(forms.ModelForm):
    class Meta:
        model = Claims
        fields = ['claimDate', 'operatingTime','malfunctionNode', 'malfunctionDescription', 'reparingMethod', 'usedSpareParts', 'repairingDate', 'vehicleDowntime', 'vehicle', 'serviceCompany', ]

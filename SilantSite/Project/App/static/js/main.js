...
if (vehicleModelFilter.value !== '') {
    // row name
    vehicleModelRowName.style.border = '2px solid #EBE6D6';
    // each element in the row
    vehicleModelRow.forEach((element) => {
        element.style.border = '2px solid #EBE6D6';
    });
} 
// engine filter
if (engineModelFilter.value !== '') {

    engineModelRowName.style.border = '2px solid #EBE6D6';
...
if (transmissionModelFilter.value !== '') {
    ...
    transmissionModelRowName.style.border = '2px solid #EBE6D6';
...
if (driveAxleModelFilter.value !== '') {
    ...
    driveAxleModelRowName.style.border = '2px solid #EBE6D6';
...
if (steeringAxleModelFilter.value !== '') {
    ...
    steeringAxleModelRowName.style.border = '2px solid #EBE6D6';
